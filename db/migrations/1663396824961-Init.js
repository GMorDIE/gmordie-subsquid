module.exports = class Init1663396824961 {
  name = 'Init1663396824961'

  async up(db) {
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "currency" text NOT NULL, "amount" numeric NOT NULL, "from_id" character varying NOT NULL, "to_id" character varying NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
